            ...
            <div className="absolute top-0 right-0 flex z-10">
                ...
                {isCreator && (
                    <button
                        ...
                        className="bg-red-600 text-white w-6 h-6 flex items-center justify-center text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-700"
                        title="Supprimer"
                    >
                        X
                    </button>
